...
namespace Authenticator.Repository.Stock
{
    public class StockRepo:IStockRepo
    {
        ...
        private async Task<Stocks> EditStock(Stocks stockmodel,UpdateStockDTO updatestock)
        {
       ...
       public HttpStatusResult StockExistsResponse()
        {
            return new HttpStatusResult()
            {
                ...
                Message = new List<string>()
                {
                    ...
                    "Message: Stock name or symbol already exists"
                }
            };
        }
        ...
        public async Task<HttpStatusResult> EditStockbyIDValidation(int id, UpdateStockDTO update)
        {
            ...
            var data = await EditStock(StockModel,update);
            return new HttpStatusResult()
            {
                StatusCode = HttpStatusCode.OK,
        ...
        public async Task<HttpStatusResult> StockDeleteValidation(int id)
        {
